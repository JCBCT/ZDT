...
struct dummy_action {
   static uint64_t get_name() {
      return zdtio::name{"dummy_action"}.value;
   }
   static uint64_t get_account() {
      return zdtio::name{"testapi"}.value;
   }
  ...
  ZDTLIB_SERIALIZE( dummy_action, (a)(b)(c) )
};

struct u128_action {
  unsigned __int128  values[3]; //16*3

  ZDTLIB_SERIALIZE( u128_action, (values) )
};

struct cf_action {
   static uint64_t get_name() {
      return zdtio::name{"cf_action"}.value;
   }
   static uint64_t get_account() {
      return zdtio::name{"testapi"}.value;
   }
   ...
   ZDTLIB_SERIALIZE( cf_action, (payload)(cfd_idx) )
};
...
struct dtt_action {
   ...
   ZDTLIB_SERIALIZE( dtt_action, (payer)(deferred_account)(deferred_action)(permission_name)(delay_sec) )
};
...
struct invalid_access_action {
   ...
   ZDTLIB_SERIALIZE( invalid_access_action, (code)(val)(index)(store) )
};
