...
void test_print::test_printn() {
   printn(zdtio::name{"1"}.value);
   printn(zdtio::name{"5"}.value);
   printn(zdtio::name{"a"}.value);
   printn(zdtio::name{"z"}.value);

   printn(zdtio::name{"abc"}.value);
   printn(zdtio::name{"123"}.value);

   printn(zdtio::name{"abc.123"}.value);
   printn(zdtio::name{"123.abc"}.value);

   printn(zdtio::name{"12345abcdefgj"}.value);
   printn(zdtio::name{"ijklmnopqrstj"}.value);
   printn(zdtio::name{"vwxyz.12345aj"}.value);

   printn(zdtio::name{"111111111111j"}.value);
   printn(zdtio::name{"555555555555j"}.value);
   printn(zdtio::name{"aaaaaaaaaaaaj"}.value);
   printn(zdtio::name{"zzzzzzzzzzzzj"}.value);
}
