...
namespace _test_multi_index {
   ...
   struct record_idx64 {
      ...
      ZDTLIB_SERIALIZE( record_idx64, (id)(sec) )
   };
   ...
   struct record_idx128 {
      ...
      ZDTLIB_SERIALIZE( record_idx128, (id)(sec) )
   };
   ...
   struct record_idx256 {
      ...
      ZDTLIB_SERIALIZE( record_idx256, (id)(sec) )
   };
   ...
   struct record_idx_double {
      ...
      ZDTLIB_SERIALIZE( record_idx_double, (id)(sec) )
   };
   ...
   struct record_idx_long_double {
      ...
      ZDTLIB_SERIALIZE( record_idx_long_double, (id)(sec) )
   };
