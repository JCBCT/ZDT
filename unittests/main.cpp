...
//extern uint32_t ZDT_TESTING_GENESIS_TIMESTAMP;
...
boost::unit_test::test_suite* init_unit_test_suite(int argc, char* argv[]) {
   ...
   /*
   const char* genesis_timestamp_str = getenv("ZDT_TESTING_GENESIS_TIMESTAMP");
   if( genesis_timestamp_str != nullptr )
   {
      ZDT_TESTING_GENESIS_TIMESTAMP = std::stoul( genesis_timestamp_str );
   }
   std::cout << "ZDT_TESTING_GENESIS_TIMESTAMP is " << ZDT_TESTING_GENESIS_TIMESTAMP << std::endl;
   */
   return nullptr;
}
