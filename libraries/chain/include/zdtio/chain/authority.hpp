...
FC_REFLECT(zdtio::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(zdtio::chain::key_weight, (key)(weight) )
FC_REFLECT(zdtio::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(zdtio::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(zdtio::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
