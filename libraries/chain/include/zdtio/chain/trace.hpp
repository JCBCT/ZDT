...
#include <zdtio/chain/action_receipt.hpp>
...
FC_REFLECT( zdtio::chain::account_delta,
            (account)(delta) )

FC_REFLECT( zdtio::chain::base_action_trace,
                    (receipt)(act)(context_free)(elapsed)(console)(trx_id)
                    (block_num)(block_time)(producer_block_id)(account_ram_deltas)(except) )

FC_REFLECT_DERIVED( zdtio::chain::action_trace,
                    (zdtio::chain::base_action_trace), (inline_traces) )

FC_REFLECT( zdtio::chain::transaction_trace, (id)(block_num)(block_time)(producer_block_id)
