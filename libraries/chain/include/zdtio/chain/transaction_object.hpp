...
CHAINBASE_SET_INDEX_TYPE(zdtio::chain::transaction_object, zdtio::chain::transaction_multi_index)

FC_REFLECT(zdtio::chain::transaction_object, (expiration)(trx_id))
