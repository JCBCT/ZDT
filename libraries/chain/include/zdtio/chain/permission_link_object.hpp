...
CHAINBASE_SET_INDEX_TYPE(zdtio::chain::permission_link_object, zdtio::chain::permission_link_index)

FC_REFLECT(zdtio::chain::permission_link_object, (account)(code)(message_type)(required_permission))
