...
#include <zdtio/chain/incremental_merkle.hpp>
...
CHAINBASE_SET_INDEX_TYPE(zdtio::chain::global_property_object, zdtio::chain::global_property_multi_index)
CHAINBASE_SET_INDEX_TYPE(zdtio::chain::dynamic_global_property_object,
                         zdtio::chain::dynamic_global_property_multi_index)

FC_REFLECT(zdtio::chain::dynamic_global_property_object,
           (global_action_sequence)
          )

FC_REFLECT(zdtio::chain::global_property_object,
