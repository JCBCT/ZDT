...
CHAINBASE_SET_INDEX_TYPE(zdtio::chain::producer_object, zdtio::chain::producer_multi_index)

FC_REFLECT(zdtio::chain::producer_object::id_type, (_id))
FC_REFLECT(zdtio::chain::producer_object, (id)(owner)(last_aslot)(signing_key)(total_missed)(last_confirmed_block_num)
           (configuration))
