...
namespace zdtio { namespace chain {
   ...
   namespace webassembly { namespace common {
      ...
      try {
         ...
         if(validating && mod_name != "env")
            ZDT_ASSERT( false, wasm_exception, "importing from module that is not 'env': ${module}.${export}", ("module",mod_name)("export",export_name) );
         ...
         ZDT_ASSERT( false, wasm_exception, "${module}.${export} unresolveable", ("module",mod_name)("export",export_name) );
         return false;
   ...
   class wasm_interface {
      public:
         ...
         //validates code -- does a WASM validation pass and checks the wasm against ZDTIO specific constraints
      ...
      private:
         ...
         friend class zdtio::chain::webassembly::common::intrinsics_accessor;
   };
...
FC_REFLECT_ENUM( zdtio::chain::wasm_interface::vm_type, (wavm)(wabt) )
