#pragma once
#include <zdtio/chain/block_header.hpp>
...
FC_REFLECT_ENUM( zdtio::chain::transaction_receipt::status_enum,
                 (executed)(soft_fail)(hard_fail)(delayed)(expired) )

FC_REFLECT(zdtio::chain::transaction_receipt_header, (status)(cpu_usage_us)(net_usage_words) )
FC_REFLECT_DERIVED(zdtio::chain::transaction_receipt, (zdtio::chain::transaction_receipt_header), (trx) )
FC_REFLECT_DERIVED(zdtio::chain::signed_block, (zdtio::chain::signed_block_header), (transactions)(block_extensions) )
