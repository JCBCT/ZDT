...
#include <zdtio/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(zdtio::chain::table_id_object, zdtio::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(zdtio::chain::key_value_object, zdtio::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(zdtio::chain::index64_object, zdtio::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(zdtio::chain::index128_object, zdtio::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(zdtio::chain::index256_object, zdtio::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(zdtio::chain::index_double_object, zdtio::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(zdtio::chain::index_long_double_object, zdtio::chain::index_long_double_index)

FC_REFLECT(zdtio::chain::table_id_object, (code)(scope)(table)(payer)(count) )
FC_REFLECT(zdtio::chain::key_value_object, (primary_key)(payer)(value) )

#define REFLECT_SECONDARY(type)\
  FC_REFLECT(type, (primary_key)(payer)(secondary_key) )

REFLECT_SECONDARY(zdtio::chain::index64_object)
REFLECT_SECONDARY(zdtio::chain::index128_object)
REFLECT_SECONDARY(zdtio::chain::index256_object)
REFLECT_SECONDARY(zdtio::chain::index_double_object)
REFLECT_SECONDARY(zdtio::chain::index_long_double_object)
