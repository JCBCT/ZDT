...
CHAINBASE_SET_INDEX_TYPE(zdtio::chain::permission_object, zdtio::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(zdtio::chain::permission_usage_object, zdtio::chain::permission_usage_index)

FC_REFLECT(zdtio::chain::permission_object, (usage_id)(parent)(owner)(name)(last_updated)(auth))
FC_REFLECT(zdtio::chain::snapshot_permission_object, (parent)(owner)(name)(last_updated)(last_used)(auth))

FC_REFLECT(zdtio::chain::permission_usage_object, (last_used))
