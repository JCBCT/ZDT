...
CHAINBASE_SET_INDEX_TYPE( zdtio::public_key_history_object, zdtio::public_key_history_multi_index )

FC_REFLECT( zdtio::public_key_history_object, (public_key)(name)(permission) )
