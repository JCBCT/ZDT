...
CHAINBASE_SET_INDEX_TYPE( zdtio::account_control_history_object, zdtio::account_control_history_multi_index )

FC_REFLECT( zdtio::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )
