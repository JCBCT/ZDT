...
#include <zdtio/wallet_plugin/wallet_api.hpp>
...
class soft_wallet final : public wallet_api
{
   public:
       ...
       *
       * example: remove_key ZDT6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV
       *
...
FC_REFLECT( zdtio::wallet::wallet_data, (cipher_keys) )

FC_REFLECT( zdtio::wallet::plain_keys, (checksum)(keys) )
